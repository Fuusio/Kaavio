...
@DisplayName("Given FalseTrigger")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
internal class FalseTriggerTest : KaavioTest() {
    ...
    inner class TrueCases {
        ...
        @Test
        @DisplayName("Then FalseTrigger should not output Unit")
        fun case1() {
    ...
    inner class FalseCase {
        ...
        @Test
        @DisplayName("Then FalseTrigger should output Unit")
        fun case1() {
