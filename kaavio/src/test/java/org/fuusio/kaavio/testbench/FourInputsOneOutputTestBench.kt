...
/**
 * [FourInputsOneOutputTestBench] provides an abstract base class for implementing a test class
 * for a [Node] that have two inputs of types [I1], [I2], [I3], [I4] and a single output of type [O].
 */
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
internal abstract class FourInputsOneOutputTestBench<I1: Any, I2: Any, I3: Any, I4: Any, O: Any>
    : KaavioTest() {
     ...
     */
    protected abstract fun testCases(): Map<Quadruple<I1, I2, I3, I4>, O>
    ...
    fun test() {
        ...
        testCases().forEach { (inputs, output) ->
            ...
            assertEquals(
                output,
                value,
                "Test case for node '${Graph.getNodeName(node)}' failed: For input values '${inputs.first}', '${inputs.second}', '${inputs.third} and '${inputs.fourth}', output value '$output' is expected."
            )
        }
    }
}